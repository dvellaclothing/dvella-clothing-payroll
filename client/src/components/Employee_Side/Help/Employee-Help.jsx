...
export default function EmployeeHelp({ pageLayout, currentUser }) {
            ...
            <div className="flex flex-col items-center justify-start h-9/10 w-full p-5 gap-5 overflow-y-scroll">
                ...
                <div className="flex flex-col w-full bg-white rounded-2xl border border-[rgba(0,0,0,0.2)] p-5 gap-3">
                    ...
                    <div className="grid grid-cols-2 md:grid-cols-4 gap-3">
                        <a href="/employee/profile" className="flex flex-col items-center justify-center p-4 border border-[rgba(0,0,0,0.1)] rounded-lg hover:bg-gray-50 transition">
                            <p className="text-sm font-medium text-center">Update Profile</p>
                        </a>
                        <a href="/employee/settings" className="flex flex-col items-center justify-center p-4 border border-[rgba(0,0,0,0.1)] rounded-lg hover:bg-gray-50 transition">
                            <p className="text-sm font-medium text-center">Change Password</p>
                        </a>
                        <a href="/employee/attendance" className="flex flex-col items-center justify-center p-4 border border-[rgba(0,0,0,0.1)] rounded-lg hover:bg-gray-50 transition">
                            <p className="text-sm font-medium text-center">View Attendance</p>
                        </a>
                        <a href="/employee/payslips" className="flex flex-col items-center justify-center p-4 border border-[rgba(0,0,0,0.1)] rounded-lg hover:bg-gray-50 transition">
                ...
                <div className="flex flex-col w-full bg-blue-50 rounded-2xl border border-blue-200 p-5 gap-3">
                    ...
                    <div className="flex flex-col md:flex-row gap-3 mt-2">
                        <div className="flex flex-col p-3 bg-white rounded-lg border border-blue-200">
                            ...
                            <p className="font-medium text-sm">hr@dvella.com</p>
                        </div>
                        <div className="flex flex-col p-3 bg-white rounded-lg border border-blue-200">
